...
public class Utilidades {
    ...
    private static ArrayList<Integer> regresarNumero(String dato) {
    ...
    private static void segundaActividad() {
        ...
        listaEspectadores = espectador.generarEspectador();
        ...
        try {
            do {
                ...
                for (int i = 0; i < listaEspectadores.size(); i++) {
                    ...
                    System.out.print(contador + ")Nombre:" + listaEspectadores.get(i).getNombre() + " "
                            + listaEspectadores.get(i).getApellido() + " Edad:"
